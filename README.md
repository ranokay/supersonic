...
* [x] High-quality gapless audio playback powered by FFmpeg and miniaudio, with optional exclusive/hog and bit-perfect modes
...
* **AppImage:** On the [latest release](https://github.com/dweymouth/supersonic/releases) page, you can download an AppImage package with audio dependencies bundled.<br/>
Tested OSes:<br/> 
ubuntu 22.04+ <br/> 
debian 12+ <br/> 
fedora 42+ <br/> 
